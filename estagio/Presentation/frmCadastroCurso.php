			   ...
			   //Atualizar Campus
					...
					echo"<form name=frmCadastroCurso' action='../Controller/CtlCurso.php?oP=2' method='POST'>";
						...
						foreach ($editar as $i){
							...
							echo"<input type='hidden' id='codCurso' name='codCurso' value='".$i->getId()."' size='2'/><br/>";
							echo"<label for='nomeDisciplina'>Nome*</label><br/>";
							echo"<input type='text' id='nomeCurso' name='nomeCurso' value='".$i->getNome()."' required size='40' maxlength='50' class='input-div'/><br/>";
							echo"<label for='siglaCurso'>Sigla*</label><br/>";
