			   ...
			   //Atualizar Campus
					...
					echo"<form name='frmCadastroTitulacao' action='../Controller/CtlTitulacao.php?oP=2' method='POST'>";
						...
						foreach ($editar as $i){
							...
							echo"<input type='hidden' id='codTitulacao' name='codTitulacao' value='".$i->getId()."' size='2'/><br/>";
							echo"<label for='nomeTitulacao'>Nome*</label><br/>";
							echo"<input type='text' id='nomeTitulacao' name='nomeTitulacao' value='".$i->getNome()."' required size='50' maxlength='50' class='input-div'/>";
							$i++;
						}
