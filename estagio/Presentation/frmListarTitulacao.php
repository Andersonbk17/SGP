...
<body>
    ...
    <fieldset >
		...
		<!--<a href="main.php?pagina=frmCadastroTitulacao.php"><img src="image/novo.png"/></a><br/>-->
                 <a href="main.php?pagina=frmCadastroTitulacao.php">        
   ...
   -->         
    ...
    <?php
                ...
                foreach ($titulacao as $i) {
                    ...
                    echo "<td class='coluna'><a href=main.php?pagina=frmCadastroTitulacao.php&aux=1&codTitulacao=" . $i->getId() . "><img src='./image/editar.png' title='Editar registro'></a></td>";
